    ...
    <div class="container-fluid">
        ...
        <div class="row cuerpo">
        	...
        	<div class="col-md-7">
                ...
                <div id="contenidos">
                <p><b>Esta dieta estará realizada por tu dietista utilizando como guía tus intercambios y tus gustos</b>. Por tanto, conociendo tus intercambios (primer cuadro que tienes a la derecha o abajo en móviles) y tus propios gustos, puedes modificar esta dieta sugerida* siguiendo las tablas de intercambios (puedes acceder a las tablas de intercambios desde el menú pulsando en Alimentos por intercambios, o pulsando <a href="cliente_alimentos_intercambio.php">este enlace</a>).</p>
				...
				<div><?php if($_SESSION["dieta"]==""){echo "Aún no tienes una dieta. ¡<a href='cliente_citas.php'>Coge cita ahora!</a>";} else {echo $_SESSION["dieta"];} ?></div>
                </div>
            </div>
