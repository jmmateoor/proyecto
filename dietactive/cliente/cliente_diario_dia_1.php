...
<head>
<meta charset="utf-8">
<title>Día 1 Diario dietético - DietActive</title>
...
<div id="loading"></div>
    ...
    <div class="container-fluid">
        ...
        <div class="row cuerpo">
        	...
        	<div class="col-md-7">
            	<h2 class="datospers">Diario Dietético - Día 1</h2><!-- CONTENIDO DE LA WEB -->
                <div id="contenidos">
                	<h3>Desayuno <button class="btn btn-primary btn-sm" onClick="empezarTest(1,'desayuno');" >Empezar</button></h3>
                    <div class="test">
                        <div id="botondesayuno"></div>
                        <div id="desayuno"></div>
                        <div id="aceptardesayuno"></div>
                    </div>
                    <h3>Almuerzo <button class="btn btn-primary btn-sm" onClick="empezarTest(1,'almuerzo');" >Empezar</button></h3>
                    <div class="test">
                    	<div id="botonalmuerzo"></div>
                    	<div id="almuerzo"></div>
                    	<div id="aceptaralmuerzo"></div>
                    </div>
                    <h3>Merienda <button class="btn btn-primary btn-sm" onClick="empezarTest(1,'merienda');" >Empezar</button></h3>
                    <div class="test">
                        <div id="botonmerienda"></div>
                        <div id="merienda"></div>
                        <div id="aceptarmerienda"></div>
                    </div>
                    <h3>Cena <button class="btn btn-primary btn-sm" onClick="empezarTest(1,'cena');" >Empezar</button></h3>
                    <div class="test">
